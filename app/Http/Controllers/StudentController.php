...
class StudentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backdirector.student.index',compact('students'));
    }
    ...
    public function create()
    {
       ...
       return view('backdirector.student.create',compact('classes','student_no'),compact('students'));
    }
    ...
    public function edit($id)
    {
        ...
        $classes = Classes::get();
        return view('backdirector.student.edit',compact('students','classes'));
    }

...
<div class="left-sidebar-pro">
    <nav id="sidebar" class="">
        <div class="sidebar-header">
            <a href="index.html"><img class="main-logo" src="{{asset('backdirector/img/logo/logo.png')}}" alt="" /></a>
            <strong></strong>
        </div>
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                <ul class="metismenu" id="menu1">
                    ...
                    <li>
                        <a class="has-arrow  ml-5" href="#" aria-expanded="false"><img src="{{asset('backdirector/img/education.png')}}" width="20px" > <span class="mini-click-non">Sınıflar</span></a>
                        <ul class="submenu-angle" aria-expanded="false">
                                        ...
                                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                    ...
                                                    <ul class="message-menu">
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <img src="{{asset('backdirector/img/contact/1.jpg')}}" alt="">
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <img src="{{asset('backdirector/img/contact/4.jpg')}}" alt="">
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Sulaiman din</h2>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <img src="{{asset('backdirector/img/contact/3.jpg')}}" alt="">
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Victor Jara</h2>
                                                        ...
                                                        <li>
                                                            <a href="#">
                                                                <div class="message-img">
                                                                    <img src="{{asset('backdirector/img/contact/2.jpg')}}" alt="">
                                                                </div>
                                                                <div class="message-content">
                                                                    <span class="message-date">16 Sept</span>
                                                                    <h2>Victor Jara</h2>
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    <img src="{{asset('backdirector/img/product/pro4.jpg')}}" alt="" />

                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                <div class="address-hr">
                                    <p><b>Ad Soyad</b><br/>{{$student->name}}</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-6">
                                <div class="address-hr tb-sm-res-d-n dps-tb-ntn">
                                    <p><b>Telefon No.</b><br/> {{$student->phone}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="address-hr">
                                    <p><b>Öğrenci Numarası</b><br/> {{$student->student_no}}</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="address-hr">
                                    <p><b>Ebeveyn İsmi</b><br/> {{$student->parent_name}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-payment-inner-st res-mg-t-30 analysis-progrebar-ctn">
                    ...
                    <div id="myTabContent" class="tab-content custom-product-edit">
                        <div class="product-tab-list tab-pane active in fade" id="reviews">
                            <div class="row">
                                <form method="post" action="{{route('student.settings.update.profile',$student->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <input name="phone" type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="form-control" placeholder="Telefon No">
                                            </div>
                                            <div class="form-group">
                        ...
                        <div class="product-tab-list tab-pane fade" id="INFORMATION">
                            <div class="row">
                                <form method="post" action="{{route('student.password.update',$user->id)}}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">

                ...
                <div class="panel-body">
                    ...
                    <form action="#" method="post" id="loginForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="örnek@gmail.com" id="email" title="Lütfen E-mail Adresinizi Giriniz"
                                   required name="email" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="password">Şifre</label>
                            <input type="password" title="Lütfen Şifrenizi Giriniz" placeholder="******" required
                                   name="password" class="form-control">
                        </div>
                        <button type="submit" class="btn btn-success btn-block loginbtn">Giriş</button>
                        <button id="ogretmenBtn" type="button" style="width:200px; margin-top:5px"
                                class="btn btn-primary">Öğretmen Girişi
                        </button>
                        <button id="ogrenciBtn" type="button" style="width:215px; margin-top:5px"
                                class="btn btn-primary">Öğrenci Girişi
                        </button>
                        <a id="createPassword" href="{{route('student.create.password')}}"
                           style="margin-top:5px; visibility:hidden;" class="btn btn-block btn-primary" type="hidden" >Şifre oluştur</a>
...
<script>
    ...
    ogretmenBtn.addEventListener('click', function () {
        ...
        email.title= "Lütfen Kullanıcı Adınızı Giriniz";
        email.placeholder= "örnek@gmail.com";
        email.type= "email";
        createPassword.style.visibility = 'hidden';
        hiddenBtn.value = 1;
    })
    ...
    ogrenciBtn.addEventListener('click', function () {
        ...
        userName.innerText = "Öğrenci Numarası";
        email.title= "Lütfen Öğrenci Numaranızı Giriniz";
        email.placeholder= "123456789";
        email.type= "number";
        createPassword.style.visibility = 'visible';
        hiddenBtn.value = 2;
    })
